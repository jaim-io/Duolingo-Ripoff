...
const sentences: Sentence[] = [
    ...
    },
    {
        ...
        dutch: [
            "O, wat goed! Ook wil ik een cannoli met chocolade en een pond koekjes om mee naar huis te nemen.",
        ],
    },
    {
        type: "sentence",
    ...
    },
    {
        type: "sentence",
        italian: [
            "Va bene. 9 euro, per favore.",
            "Va bene. Nove euro, per favore.",
        ],
        dutch: ["Oke. 9 euro, alstublieft.", "Oke. Negen euro, alstublieft."],
    },
    {
        type: "sentence",
    ...
    {
        type: "sentence",
        italian: ["Che cosa prendi?", "Che prendi?", "Cosa prendi?"],
        dutch: ["Wat neem jij?"],
    },
    {
        type: "sentence",
